...
public:
	...
	uint8                                         bAffectNavigation : 1;                             // 0x0330(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_331[0x7];                                      // 0x0331(0x0007)(Fixing Size After Last Property [ Dumper-8 ])
	UMulticastDelegateProperty_                   OnActorFracture;                                   // 0x0338(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         bFractureEffectOverride : 1;                       // 0x0728(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_729[0x7];                                      // 0x0729(0x0007)(Fixing Size After Last Property [ Dumper-8 ])
	TArray<struct FFractureEffect>                FractureEffects;                                   // 0x0730(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, EditFixedSize, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bEnableHardSleeping;                               // 0x0740(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_741[0x3];                                      // 0x0741(0x0003)(Fixing Size After Last Property [ Dumper-8 ])
	float                                         LargeChunkThreshold;                               // 0x0744(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_748[0x10];                                     // 0x0748(0x0010)(Fixing Size After Last Property [ Dumper-8 ])
	UMulticastDelegateProperty_                   OnComponentFracture;                               // 0x0758(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_768[0x98];                                     // 0x0768(0x0098)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	struct FDestructibleParameters                DefaultDestructibleParameters;                     // 0x0310(0x0088)(Edit, NativeAccessSpecifierPublic)
	TArray<struct FFractureEffect>                FractureEffects;                                   // 0x0398(0x0010)(Edit, EditFixedSize, ZeroConstructor, NativeAccessSpecifierPublic)
