...
namespace Offsets
{
	constexpr int32 GObjects          = 0x02D65B00;
	constexpr int32 AppendString      = 0x006A50C0;
	constexpr int32 GNames            = 0x030DBB60;
	constexpr int32 GWorld            = 0x031DEB80;
	constexpr int32 ProcessEvent      = 0x00829510;
	constexpr int32 ProcessEventIdx   = 0x00000041;
    constexpr int32 Free              = 0x005E33B0;
    constexpr int32 Realloc           = 0x005EF470;
}
