...
public:
	...
	class USceneComponent*                        CallFunc_Array_Get_Item;                           // 0x0010(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ABP_Train_C*                            K2Node_DynamicCast_AsBP_Train;                     // 0x00D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FRotator                               CallFunc_K2_GetActorRotation_ReturnValue;          // 0x00E4(0x000C)(IsPlainOldData, NoDestructor)
	struct FVector                                CallFunc_GreaterGreater_VectorRotator_ReturnValue; // 0x00F0(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class USceneComponent*>                CallFunc_GetChildrenComponents_Children;           // 0x0110(0x0010)(ZeroConstructor, ReferenceParm)
...
public:
	...
	class UStaticMesh*                            CallFunc_Array_Get_Item1;                          // 0x0040(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
